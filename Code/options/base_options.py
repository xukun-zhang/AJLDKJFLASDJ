...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--dataroot', default="/home/xxx/Ours/datasets/Ours-Real", help='path to meshes (should have subfolders train, test)')
        self.parser.add_argument('--dataset_mode', choices={"classification", "segmentation"}, default='segmentation')
        self.parser.add_argument('--ninput_edges', type=int, default=6000, help='# of input edges (will include dummy edges)')
        ...
        self.parser.add_argument('--pool_res', nargs='+', default=[6000, 1140, 780, 750], type=int, help='pooling res')
