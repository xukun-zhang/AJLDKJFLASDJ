    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            for file_i in range(label_class.shape[0]):
                ...
                path_file_i_p = os.path.join("/home/xxx/Ours/test_results", file_name_pred)
                path_file_i_l = os.path.join("/home/xxx/Ours/test_results", file_name_label)
                ...
                correct_1 = dice_coefficient(pred_class[file_i][mask_re], label_class[file_i][mask_re])

                acc_1 = correct_1
                correct = correct + correct_1

                print("这个数据的预测脊的准确率为:", acc_1, self.mesh[file_i].filename)
