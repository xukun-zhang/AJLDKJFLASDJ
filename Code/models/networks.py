...
class DownConv(nn.Module):
    def __init__(self, in_channels, out_channels, blocks=0, pool=0):
        ...
        self.conv1_e_2 = MeshConv_CBAM(in_channels, out_channels, 1140)
        self.conv1_e_3 = MeshConv_CBAM(in_channels, out_channels, 780)
        self.conv1_e_4 = MeshConv_CBAM(in_channels, out_channels, 750)
        self.conv1_p_1 = MeshConv(in_channels, out_channels)
        self.conv1_p_2 = MeshConv_CBAM(in_channels, out_channels, 1140)
        self.conv1_p_3 = MeshConv_CBAM(in_channels, out_channels,  780)
        self.conv1_p_4 = MeshConv_CBAM(in_channels, out_channels, 750)
